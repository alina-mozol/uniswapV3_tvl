...
const RPC_URL = "https://eth-mainnet.g.alchemy.com/v2/9Z-6DfGG-EcL4Lisctfm_";
...
const getAmounts = async () => {
	...
	const poolContract = new web3.eth.Contract(
		UniswapV3PoolABI,
		'0x3416cF6C708Da44DB2624D63ea0AAef7113527C6' // USDT-USDC
	);

	const poolData = await getPoolData(poolContract)


	const UsdtToken = new Token(1, "0xdAC17F958D2ee523a2206206994597C13D831ec7", 6, 'USDT', 'Tether')
	const UsdcToken = new Token(1, "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48", 6, 'USDC', 'UsdCoin')

	console.log('poolData', poolData)
	console.log('tickLower', nearestUsableTick(parseInt(poolData.tick), parseInt(poolData.tickSpacing)))
	console.log('tickLower1', nearestUsableTick(parseInt(poolData.tick), parseInt(poolData.tickSpacing)) - poolData.tickSpacing * 2)
	console.log('tickUpper', nearestUsableTick(parseInt(poolData.tick), parseInt(poolData.tickSpacing)))
	console.log('tickUpper1', nearestUsableTick(parseInt(poolData.tick), parseInt(poolData.tickSpacing)) + poolData.tickSpacing * 2)

	const pool = new Pool(
		UsdtToken,
		UsdcToken,
		parseInt(poolData.fee),
